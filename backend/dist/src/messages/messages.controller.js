...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create or get a conversation with another user' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get list of conversations for current user' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
