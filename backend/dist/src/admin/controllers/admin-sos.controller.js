...
let AdminSOSController = class AdminSOSController {
    ...
    async resolveSOS(id, status, req) {
...
], AdminSOSController.prototype, "getActiveSOS", null);
__decorate([
    (0, roles_decorator_1.Roles)('ADMIN', 'MODERATOR'),
    ...
    __metadata("design:returntype", Promise)
], AdminSOSController.prototype, "resolveSOS", null);
exports.AdminSOSController = AdminSOSController = __decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, common_1.Controller)('admin/sos-alerts'),
